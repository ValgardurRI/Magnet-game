...
{
    public class DoorItem : DesignerToolbarItem, IMagnetic
    {
        ...
        {
            var piece = board.AddPiece(new Piece { Type = Piece.PieceType.Door, MagnetPolarity = (polarityStrength > 0), MagnetStrength = Mathf.Abs(polarityStrength) }, field);
